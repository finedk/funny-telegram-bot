...
+ При скачивании стикера в его название вставляются: название стикерпака и его `file_unique_id`. Например - `"NordsKonosuba - @AgADigcAAt5A-Ac"` и `"nagatoro_manga - @AgAD2AADTptkAg"`
