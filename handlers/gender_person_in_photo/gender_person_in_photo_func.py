...
async def gender_person_in_photo_photo(message: types.Message, state: FSMContext):
    ...
    res = await resolve(f"./handlers/gender_person_in_photo/temp/{temp}.jpg") # res = ["male", or "female"]
    os.remove(f"./handlers/gender_person_in_photo/temp/{temp}.jpg")
    if res == "No face detected":
        await message.reply("На этом фото нет лица")
    elif res[0] == "male":
        await message.reply("На этом фото изображен - мужчина")
    elif res[0] == "female":
...
faceProto = "./handlers/gender_person_in_photo/data/opencv_face_detector.pbtxt"
faceModel = "./handlers/gender_person_in_photo/data/opencv_face_detector_uint8.pb"
genderProto = "./handlers/gender_person_in_photo/data/gender_deploy.prototxt"
genderModel = "./handlers/gender_person_in_photo/data/gender_net.caffemodel"
